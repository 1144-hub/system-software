...
int main()
{
    int fd = open("/home/ronakgoyal/Q18main.txt", O_RDWR);
...
/*
ronakgoyal@Administrators-MacBook-Pro handson1 % touch q18a.c
ronakgoyal@Administrators-MacBook-Pro handson1 % gcc q18a.c  
